...
--
-- Name: contacts; Type: TABLE; Schema: webinfo; Owner: postgres
--

CREATE TABLE webinfo.contacts (
    id integer NOT NULL,
    contact xml
);


ALTER TABLE webinfo.contacts OWNER TO postgres;

--
-- Name: contacts_id_seq; Type: SEQUENCE; Schema: webinfo; Owner: postgres
--

CREATE SEQUENCE webinfo.contacts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE webinfo.contacts_id_seq OWNER TO postgres;

--
-- Name: contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: webinfo; Owner: postgres
--

ALTER SEQUENCE webinfo.contacts_id_seq OWNED BY webinfo.contacts.id;
...
--
-- Name: emails_sent; Type: TABLE; Schema: webinfo; Owner: postgres
--

CREATE TABLE webinfo.emails_sent (
    id integer NOT NULL,
    messagee_id character varying(200),
    to_ character varying(256),
    from_ character varying(256),
    subject character varying(256),
    texto text,
    html text,
    attach jsonb,
    user_sent integer NOT NULL,
    fecha_sent timestamp with time zone DEFAULT now()
);


ALTER TABLE webinfo.emails_sent OWNER TO postgres;

--
-- Name: emails_sent_id_seq; Type: SEQUENCE; Schema: webinfo; Owner: postgres
--

CREATE SEQUENCE webinfo.emails_sent_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE webinfo.emails_sent_id_seq OWNER TO postgres;

--
-- Name: emails_sent_id_seq; Type: SEQUENCE OWNED BY; Schema: webinfo; Owner: postgres
--

ALTER SEQUENCE webinfo.emails_sent_id_seq OWNED BY webinfo.emails_sent.id;
...
--
-- Name: contacts id; Type: DEFAULT; Schema: webinfo; Owner: postgres
--

ALTER TABLE ONLY webinfo.contacts ALTER COLUMN id SET DEFAULT nextval('webinfo.contacts_id_seq'::regclass);
...
--
-- Name: emails_sent id; Type: DEFAULT; Schema: webinfo; Owner: postgres
--

ALTER TABLE ONLY webinfo.emails_sent ALTER COLUMN id SET DEFAULT nextval('webinfo.emails_sent_id_seq'::regclass);
...
--
-- Name: contacts contacts_pkey; Type: CONSTRAINT; Schema: webinfo; Owner: postgres
--

ALTER TABLE ONLY webinfo.contacts
...
--
-- Name: emails_sent emails_sent_pkey; Type: CONSTRAINT; Schema: webinfo; Owner: postgres
--

ALTER TABLE ONLY webinfo.emails_sent
...
--
-- Name: id_estado_leido; Type: INDEX; Schema: webinfo; Owner: postgres
--

CREATE INDEX id_estado_leido ON webinfo.mailstatus USING btree (id_user, leido);


--
-- Name: id_leido_estado; Type: INDEX; Schema: webinfo; Owner: postgres
--

CREATE INDEX id_leido_estado ON webinfo.mailstatus USING btree (leido, id_user);


--
-- Name: id_leido_estado_partial; Type: INDEX; Schema: webinfo; Owner: postgres
--

CREATE INDEX id_leido_estado_partial ON webinfo.mailstatus USING btree (id_user) WHERE leido;


--
-- Name: id_xi_dmail; Type: INDEX; Schema: webinfo; Owner: postgres
--

CREATE INDEX id_xi_dmail ON webinfo.mailstatus USING btree (idmail);
